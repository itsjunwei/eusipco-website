...
S1 = [
 ...
 dict(authors="D. Berghi and P. J. B. Jackson",
      ...
      venue="IEEE Signal Processing Letters", year=2026, type="journal", doi="10.1109/LSP.2026.3685150"),
 dict(authors="J.-W. Yeow, E.-L. Tan, J. Bai, S. Peksi, and W.-S. Gan",
      ...
      venue="IEEE Sensors Journal", info="vol. 25, pp. 29221–29237", year=2025, type="journal"),
      # source gave only an IEEE Xplore search link; canonical URL/DOI deferred to Phase 2
...
payload = {
    ...
    "sections": {
        "1": "Spatial Perception — Data-Centric AI for Acoustics (J.-W. Yeow)",
        "2": "Contextual Understanding (E.-L. Tan)",
        "3": "Context-Aware Action: Active Noise Control (W.-S. Gan)",
        "4": "Context-Aware Action: Soundscape Augmentation (W.-S. Gan)",
        "5": "Towards Intelligent Sound Management (W.-S. Gan)",
    },
